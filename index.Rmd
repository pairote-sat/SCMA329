...
**Note** $i^{(p)}$ is a nominal rate of interest which is equivalent to $i^{(p)}/p$ applied for
each $p$th of a period. The interest is paid $p$ times per measurement period. 

The value at time $n$ can be considered as the **annuity** with a cashflow of $i^{(p)}/p$ per period for $n$ years together with the capital at time $n$ as shown in the following figure. 
...
\draw (61,131.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (180,145.5) node   [align=left] {$\displaystyle \frac{1}{p}$};
% Text Node
\draw (302,146.5) node   [align=left] {$\displaystyle \frac{2}{p}$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (601,90) node   [align=left] {Year};
% Text Node
\draw (420,146.5) node   [align=left] {$\displaystyle \frac{3}{p}$};
% Text Node
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (182,38) node   [align=left] {$\displaystyle \frac{i^{( p)}}{p}$};
% Text Node
\draw (301,37) node   [align=left] {$\displaystyle \frac{i^{( p)}}{p}$};
% Text Node
\draw (421,37) node   [align=left] {$\displaystyle \frac{i^{( p)}}{p}$};
% Text Node
\draw (571,37) node   [align=left] {$\displaystyle \frac{i^{( p)}}{p} +1$};
\end{tikzpicture}
```
...
made for a specific period of time, they are called *annuity certain*.
...
| Real    | -100    | $\      | \$ \fra | \$ \fra | $\      | $\      |
| value   |         | fr      | c{      | c{      | fr      | fr      |
| of c    |         | ac {( 8 | (8)(9 8 | (8)(9 8 | ac {( 8 | ac {( 8 |
| ashflow |         | )(98 .  | .25)}{  | .25)}{  | )(98 .  | )(98 .  |
| at      |         | 25)}{1  | 9       | 9       | 25)}{1  | 25)}{1  |
| $t = 0$ |         | 00.15}$ | 9.74}\$ | 9.21}\$ | 00.75}$ | 01.44}$ |
+---------+---------+---------+---------+---------+---------+---------+
| Real    | -100    | = 7.85  | = 7.88  | = 7.91  | = 7.80  | =       |
| value   |         |         |         |         |         | 104.60  |
| of c    |         |         |         |         |         |         |
| ashflow |         |         |         |         |         |         |
| at      |         |         |         |         |         |         |
