...
-   **Financial statement model:** The model includes three main
...
-   **Project finance models:** The model incorporates two main elements
...
-   **Discounted cashflow model:** It is the model to value a company
...
-   **Pricing models:** This models the way prices are set within a
...
::: {.example}
*A series of payments into and out of a bank account is given as
follows:*
...
```{tikz, tikz-ex1, fig.cap = "an example of a timeline", fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw    (49.5,111) -- (622.5,110) ;
\draw [shift={(624.5,110)}, rotate = 539.9] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da597257855042824] 
\draw    (65,105) -- (65,116) ;
%Straight Lines [id:da9474951160801843] 
\draw    (186,106) -- (186,117) ;
%Straight Lines [id:da6185331554915787] 
\draw    (306,105) -- (306,116) ;
%Straight Lines [id:da5682405407635602] 
\draw    (543,106) -- (543,117) ;
%Straight Lines [id:da6916216612158876] 
\draw    (425,105) -- (425,116) ;
%Straight Lines [id:da5378437724389864] 
\draw    (65,65) -- (64.53,94) ;
\draw [shift={(64.5,96)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5881588816774714] 
\draw    (306,68) -- (305.53,97) ;
\draw [shift={(305.5,99)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da048688156533002847] 
\draw    (244,150) -- (243.53,179) ;
\draw [shift={(243.5,181)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da15939998725879834] 
\draw    (544,148) -- (543.53,177) ;
\draw [shift={(543.5,179)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6370813272398017] 
\draw    (245,106) -- (245,117) ;
%Straight Lines [id:da9187291775490731] 
\draw    (365,106) -- (365,117) ;
%Straight Lines [id:da1823632976469891] 
\draw    (363,149) -- (362.53,178) ;
\draw [shift={(362.5,180)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (66,131.5) node   [align=left] {$\displaystyle 1/1/2014$};
% Text Node
\draw (185,132.5) node   [align=left] {$\displaystyle 1/1/2015$};
% Text Node
\draw (309,131.5) node   [align=left] {$\displaystyle 1/1/2016$};
% Text Node
\draw (544,132.5) node   [align=left] {$\displaystyle 1/1/2018$};
% Text Node
\draw (426,131.5) node   [align=left] {$\displaystyle 1/1/2017$};
% Text Node
\draw (66,49) node   [align=left] {$\displaystyle 1000$};
% Text Node
\draw (307,52) node   [align=left] {$\displaystyle 100$};
% Text Node
\draw (245,195) node   [align=left] {$\displaystyle 200$};
% Text Node
\draw (545,194) node   [align=left] {$\displaystyle 400$};
% Text Node
\draw (594,30) node   [align=left] {Inflows};
% Text Node
\draw (600,219) node   [align=left] {Outflows};
% Text Node
\draw (364,194) node   [align=left] {$\displaystyle 300$};
% Text Node
\draw (606,90) node   [align=left] {Time};
\end{tikzpicture}
```
...
**Note** We refer to the amount to which the capital accumulates with
the addition of interest as *accumulation* or *accumulated value*.
...
The present value of this amount $X$ in year 2 is $$ 1100/(1 + r)^2.$$ Assuming $r = 5\%$, the present value of $X$ is `r 1100/(1 + 0.05)^2`.
...
2.  At the end of 3 months the interest earned is
...
```{tikz, tikz-ex2, fig.cap = "a timeline of compounding interest", fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
\tikzset{every picture/.style={line width=0.75pt}} 
...
%Straight Lines [id:da5378437724389864] 
\draw    (60,65) -- (59.53,94) ;
\draw [shift={(59.5,96)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5881588816774714] 
\draw    (301,68) -- (300.53,97) ;
\draw [shift={(300.5,99)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da048688156533002847] 
\draw    (180,150) -- (179.53,179) ;
\draw [shift={(179.5,181)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da15939998725879834] 
\draw    (571,148) -- (570.53,177) ;
\draw [shift={(570.5,179)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da1823632976469891] 
\draw    (300,149) -- (299.53,178) ;
\draw [shift={(299.5,180)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
%Curve Lines [id:da4614876306299549] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 4.5pt off 4.5pt}]  (182,211) .. controls (112.85,289.61) and (142.2,-72.35) .. (179.93,34.36) ;
\draw [shift={(180.5,36)}, rotate = 251.26] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Curve Lines [id:da39377803570031134] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ] [dash pattern={on 4.5pt off 4.5pt}]  (282,211) .. controls (212.85,289.61) and (242.2,-72.35) .. (279.93,34.36) ;
\draw [shift={(280.5,36)}, rotate = 251.26] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da43730719784498717] 
\draw    (419,105) -- (419,116) ;
%Straight Lines [id:da09499270145029604] 
\draw    (418,149) -- (417.53,178) ;
\draw [shift={(417.5,180)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
% Text Node
\draw (61,49) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (302,52) node   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{( 1+i)^{2}}$};
% Text Node
\draw (181,195) node   [align=left] {$\displaystyle ( 1+i)$};
% Text Node
\draw (572,194) node   [align=left] {$\displaystyle ( 1+i)^{n}$};
% Text Node
\draw (301,194) node   [align=left] {$\displaystyle ( 1+i)^{2}$};
% Text Node
\draw (601,90) node   [align=left] {Time};
% Text Node
\draw (182,53) node   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{(}\textcolor[rgb]{0.29,0.56,0.89}{1+i}\textcolor[rgb]{0.29,0.56,0.89}{)}$};
% Text Node
\draw (420,131.5) node   [align=left] {$\displaystyle 3$};
% Text Node
\draw (419,194) node   [align=left] {$\displaystyle ( 1+i)^{3}$};
% Text Node
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
\end{tikzpicture}
```
...
The value at time $n$ can be considered as the **annuity** with a cashflow of $i^{(m)}/m$ per period for $n$ years together with the capital at time $n$ as shown in the following figure. 
...
```{tikz, tikz-ex5, fig.cap = "Frequency of Compouding vs Annuity", fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
%Straight Lines [id:da8691686097400964] 
\draw    (44.5,111) -- (617.5,110) ;
\draw [shift={(619.5,110)}, rotate = 179.9] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da597257855042824] 
\draw    (60,106) -- (60,117) ;
%Straight Lines [id:da9474951160801843] 
\draw    (181,106) -- (181,117) ;
...
\draw    (520,69) -- (519.53,98) ;
\draw [shift={(519.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (61,131.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (180,145.5) node   [align=left] {$\displaystyle \frac{1}{4}$};
% Text Node
\draw (302,146.5) node   [align=left] {$\displaystyle \frac{2}{4}$};
% Text Node
\draw (520,129.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (591,90) node   [align=left] {Year};
% Text Node
\draw (420,146.5) node   [align=left] {$\displaystyle \frac{3}{4}$};
% Text Node
\draw (182,38) node   [align=left] {$\displaystyle \frac{12\%}{4}$};
% Text Node
\draw (301,37) node   [align=left] {$\displaystyle \frac{12\%}{4}$};
% Text Node
\draw (421,37) node   [align=left] {$\displaystyle \frac{12\%}{4}$};
% Text Node
\draw (520,37) node   [align=left] {$\displaystyle \frac{12\%}{4} +100$};
...
```{tikz, tikz-ex4, fig.cap = "Frequency of Compouding vs Annuity", fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
\tikzset{every picture/.style={line width=0.75pt}}         
...
\draw (61,131.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (180,145.5) node   [align=left] {$\displaystyle \frac{1}{m}$};
% Text Node
\draw (302,146.5) node   [align=left] {$\displaystyle \frac{2}{m}$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (601,90) node   [align=left] {Year};
% Text Node
\draw (420,146.5) node   [align=left] {$\displaystyle \frac{3}{m}$};
% Text Node
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (182,38) node   [align=left] {$\displaystyle \frac{i^{( m)}}{m}$};
% Text Node
\draw (301,37) node   [align=left] {$\displaystyle \frac{i^{( m)}}{m}$};
% Text Node
\draw (421,37) node   [align=left] {$\displaystyle \frac{i^{( m)}}{m}$};
% Text Node
\draw (571,37) node   [align=left] {$\displaystyle \frac{i^{( m)}}{m} +1$};
\end{tikzpicture}
```
...
::: {.example}
*An investor invests ฿1 at 7.5% p.a. (per annum) effective. Then*
$i = 0.075$. Calculate the value of investment after one year.
:::

**Solution:** The value of investment after one year at this rate is
$$1 \times ( 1 + 0.075) = 1.075.$$
In particular, the amount of 
interest received at the end of the year per ฿1 invested is 0.075.

::: {.example}
*An investor invests ฿1000 at 5.25% per half-year effective. Then*
$i = 0.0525$. Calculate the value of investment after half a year.
:::

**Solution:** The value of investment after half year at this rate is
...
::: {.example}
*An investor invests ฿1 at effective rate* $i$% per time unit for $n$
time units. Calculate the value of investment after two, three,
$\ldots$, $n$ time units.
:::

**Note** Here we assume that we can take money out and reinvest it as
new capital (see the timeline).



```{tikz, tikz-ex6, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
\tikzset{every picture/.style={line width=0.75pt}} 
...
::: {.example}
*An investor invests ฿200 at* $3$% pa effective. What will be the
deposit have accumulated to after 5 years.
:::

**Solution:** The deposit accumulates to
...
1.  *An investor invests ฿500 at* $2.75$% per quarter effective. What
    will be the deposit have accumulated to after 9 months.

2.  *An investor invests ฿2000 at* $6$% per half-year effective. What
    will be the deposit have accumulated to after 2 years.
:::

**Solution:**

1.  Accumulating the 500 for 9 months at this rate gives
    $$500 \cdot (1.0275)^3 = 542.394773.$$

2.  After 2 years the accumulation is
    $$2000 \cdot (1.06)^4 = 2524.95392.$$

**Notes** 

1. The model under the effective rate of interest condition is a
model of *compound interest*, where interest is earned on interest
previously earned. Unless state otherwise, we shall assume that $i$ is
the compound interest rate.

2.  In practice, it is easier to work with the effective rate of
...
1.  *Express a nominal annual interest rate of 9% convertible
    half-yearly as a monthly effective interest.*

2.  *Express a two-monthly effective interest of 3% as a nominal annual
    interest rate convertible two-monthly.*
:::

**Solution:**

1.  The effective rate $i$% p.a. is $$i = ( 1 + \frac{0.09}{2})^2 - 1.$$
...
::: {.example}
*Find the condition under which the two effective rates of interest* $i$
and $j$ are equivalent.
:::

**Solution:** Suppose we invest 1 for one year. Then at the end of the
...
1.  Accumulating the ฿200 for the first year at the rate of 4% p.a.
...
::: {.example}
*The effective rate of interest per annum was 6% during 2015, 8% during
2016 and 10% during 2017. Calculate the following accumulation factors.*

1.  $A(01/01/15, 01/01/18),$ i.e. the accumulation at 01/01/18 of an
    investent of 1 at 01/01/15

2.  $A(01/07/15, 01/07/17)$

3.  $A(01/04/16, 01/10/17)$
:::

**Solution:**

1.  $A(01/01/15, 01/01/18) = (1.06)(1.08)(1.1) = 1.25928$

2.  $A(01/07/15, 01/07/17) = (1.06)^{1/2}(1.08)(1.1)^{1/2} = 1.166200$

3.  $A(01/04/16, 01/10/17) = (1.08)^{3/4}(1.1)^{3/4} = 1.137922$
...
฿10000 in two years is called the *present value (PV)* or *discounted
value* of the payments.
...
::: {.example}
*Calculate the present of ฿25000 due in 3 years at an effective rate of
...
::: {.example}
*How much should we invest now to meet a liability of ฿50000 in 5 years
at an effective rate of interest of 3% per half-year.*
:::

**Solution:** The amount we need to invest now to meet the future
liability of 50000 in 5 years is the present value
$$50000 \cdot \frac{1}{1.03^{10}} = 37204.695745.$$

**Note** It follows that the $PV$ of ฿1 in $t$ time units at $i$
effective rate of interest per time unit is
$$PV = \frac{1}{(1+i)^t} = v^t.$$

::: {.example}
*Given the discount factor per year* $v = 0.9$, calculate

1.  *the effective rate of interest per year.*

2.  *the equivalent discount factor per half-year.*
:::

**Solution:**

1.  From $\displaystyle{ v= \frac{1}{1+i} = 0.9}$, solving the equation
    for $i$ gives $$i = \frac{1}{v} - 1 = 0.111111 \text{ per year}.$$

2.  Let $j$ be the effective rate of interest per half-year. Then
...
2.  For $r < s < t$, the following holds:
...
2.  the amount of payments, denoted by $C_{r}$ (or $C_{t_r}$), which
...
```{tikz, tikz-ex7, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw    (23.5,41) .. controls (35.5,24) and (214,-44) .. (321,103) ;
...
\draw    (320.78,100.75) .. controls (314.54,26.77) and (415.03,-33.29) .. (467,37) ;
\draw [shift={(321,103)}, rotate = 263.53] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
::: {.example}
*Let* $i = 4\%$ effective per time unit. Cashflows are given as follows:
...
```{tikz, tikz-ex8, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
%Straight Lines [id:da048688156533002847] 
\draw    (520,158) -- (519.53,187) ;
\draw [shift={(519.5,189)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da15939998725879834] 
\draw    (620,158) -- (619.53,187) ;
\draw [shift={(619.5,189)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da8577021712761623] 
\draw    (319,114) -- (319,125) ;
%Straight Lines [id:da9594183913234795] 
\draw    (419,113) -- (419,124) ;
...
% Text Node
\draw (620,142.5) node   [align=left] {$\displaystyle 6$};
% Text Node
\draw (521,141.5) node   [align=left] {$\displaystyle 5$};
% Text Node
\draw (122,59) node   [align=left] {$\displaystyle 200$};
% Text Node
\draw (521,203) node   [align=left] {$\displaystyle -100$};
% Text Node
\draw (621,204) node   [align=left] {$\displaystyle -50$};
% Text Node
\draw (636,104) node   [align=left] {Time};
% Text Node
\draw (318,140.5) node   [align=left] {$\displaystyle 3$};
% Text Node
\draw (421,139.5) node   [align=left] {$\displaystyle 4$};
% Text Node
\draw (321,59) node   [align=left] {$\displaystyle 300$};
...
1.  The series of cashflows is shown in the following timeline. The
...
::: {.example}
*Let* $i$ be the constant effective rate of interest per time unit. Show
...
```{tikz, tikz-ex9, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\begin{align} 
 s_\angl{n} &= \sum_{r=1}^n C_r \cdot A(t_r,n) \\
    &= (1+i)^{n-1} + (1+i)^{n-2} + \ldots + (1+i) + 1. (\#eq:firstEq) 
\end{align}
```
Multiplying Eq.\@ref(eq:firstEq) through by (1+i) gives \begin{equation}
...
**Solution:** Taking the accumulated value at time $n$ and discounting
...
1.  The timeline of this transaction is shown in the figure below.

```{tikz, tikz-ex10, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw (302,131.5) node   [align=left] {$\displaystyle 2$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle 12$};
% Text Node
\draw (601,90) node   [align=left] {Year};
% Text Node
\draw (420,131.5) node   [align=left] {$\displaystyle 3$};
...
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (182,54) node   [align=left] {$\displaystyle 500$};
% Text Node
\draw (301,54) node   [align=left] {$\displaystyle 500$};
% Text Node
\draw (421,54) node   [align=left] {$\displaystyle 500$};
% Text Node
\draw (571,54) node   [align=left] {500};
...
3.  An interest rate of 8% p.a. is equivalent to an effective
...
An *annuity-due* is an annuity where the payments made at the start of
each time period (instead of a the end), i.e. the payments are paid *in
advance*.
...
#### The rate of discount {#the-rate-of-discount .unnumbered}
...
```{tikz, tikz-ex12, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
%Straight Lines [id:da8691686097400964] 
\draw    (44.5,111) -- (258.5,111.99) ;
\draw [shift={(260.5,112)}, rotate = 180.27] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da597257855042824] 
\draw    (60,106) -- (60,117) ;
%Straight Lines [id:da9474951160801843] 
\draw    (181,106) -- (181,117) ;
%Straight Lines [id:da1927000421177052] 
\draw    (61,69) -- (60.53,98) ;
\draw [shift={(60.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5757036058163636] 
\draw    (180,148) -- (179.53,177) ;
\draw [shift={(179.5,179)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw (180,132.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (241,90) node   [align=left] {Time};
% Text Node
\draw (62,54) node   [align=left] {$\displaystyle ?$};
% Text Node
\draw (180,195.5) node   [align=left] {$\displaystyle 1$};
...
```{tikz, tikz-ex14, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
%Straight Lines [id:da8691686097400964] 
\draw    (44.5,111) -- (420.5,111.99) ;
\draw [shift={(422.5,112)}, rotate = 180.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da597257855042824] 
\draw    (60,106) -- (60,117) ;
%Straight Lines [id:da9474951160801843] 
\draw    (181,106) -- (181,117) ;
...
\draw    (61,69) -- (60.53,98) ;
\draw [shift={(60.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da1842490054646806] 
\draw    (341,106) -- (341,117) ;
%Straight Lines [id:da7547448836866759] 
\draw    (340,148) -- (339.53,177) ;
\draw [shift={(339.5,179)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw (180,132.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (401,90) node   [align=left] {Time};
% Text Node
\draw (62,54) node   [align=left] {$\displaystyle ?$};
% Text Node
\draw (340,132.5) node   [align=left] {$\displaystyle n$};
% Text Node
\draw (340,195.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (260,124.5) node   [align=left] {$\displaystyle .\ .\ .$};
...
::: {.example}
*Discount ฿2,000 for 3 years using the effective rate of discount of 5%
per annum.*
:::

**Solution:** After 1 year the discount will be $0.05 \cdot 2000 = 100,$
...
::: {.example}
*The effective rate of discount* $d$ per time unit can be regarded as
the interest paid in advance at time 0, which is equivalent to the
effective rate of interest $i$ payable in arrears.
:::

**Solution:** To show this, suppose that the bank added interest of $x$
...
```{tikz, tikz-ex15, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
%Straight Lines [id:da8691686097400964] 
\draw    (104.5,71) -- (480.5,71.99) ;
\draw [shift={(482.5,72)}, rotate = 180.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da597257855042824] 
\draw    (120,66) -- (120,77) ;
%Straight Lines [id:da1927000421177052] 
\draw    (121,29) -- (120.53,58) ;
\draw [shift={(120.5,60)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da1842490054646806] 
\draw    (401,66) -- (401,77) ;
%Straight Lines [id:da7547448836866759] 
\draw    (400,108) -- (399.53,137) ;
\draw [shift={(399.5,139)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da09254361578257253] 
\draw    (104.5,270) -- (480.5,270.99) ;
\draw [shift={(482.5,271)}, rotate = 180.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da34715003290010693] 
\draw    (120,265) -- (120,276) ;
%Straight Lines [id:da1006730032243719] 
\draw    (121,228) -- (120.53,257) ;
\draw [shift={(120.5,259)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6591600982218124] 
\draw    (401,265) -- (401,276) ;
%Straight Lines [id:da9613278244556793] 
\draw    (400,307) -- (399.53,336) ;
\draw [shift={(399.5,338)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da06558227969027053] 
\draw    (120,108) -- (119.53,137) ;
\draw [shift={(119.5,139)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Curve Lines [id:da2923604966558815] 
\draw    (139.5,170) .. controls (149.74,187.55) and (136.21,187.99) .. (122.55,204.68) ;
\draw [shift={(121.5,206)}, rotate = 307.87] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Ellipse [id:dp8888928547826969] 
\draw   (122.5,152) .. controls (122.5,144.82) and (128.66,139) .. (136.25,139) .. controls (143.84,139) and (150,144.82) .. (150,152) .. controls (150,159.18) and (143.84,165) .. (136.25,165) .. controls (128.66,165) and (122.5,159.18) .. (122.5,152) -- cycle ;

% Text Node
\draw (121,151.5) node   [align=left] {$\displaystyle 1+\ \textcolor[rgb]{0.29,0.56,0.89}{x}$};
% Text Node
\draw (461,50) node   [align=left] {Time};
% Text Node
\draw (122,14) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (400,92.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (400,155.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (121,290.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (461,249) node   [align=left] {Time};
% Text Node
\draw (122,213) node   [align=left] {$\displaystyle x$};
% Text Node
\draw (400,291.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (400,354.5) node   [align=left] {$\displaystyle x\cdot ( 1+i)$};
% Text Node
\draw (120,92.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (42,4) node [anchor=north west][inner sep=0.75pt]   [align=left] {Bank A};
% Text Node
\draw (43,203) node [anchor=north west][inner sep=0.75pt]   [align=left] {Bank B};
...
```{tikz, tikz-ex16, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw [shift={(180.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da43730719784498717] 
\draw    (449,105) -- (449,116) ;
%Straight Lines [id:da5347119577328068] 
\draw    (450,69) -- (449.53,98) ;
\draw [shift={(449.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da21105992529208994] 
\draw    (61,69) -- (60.53,98) ;
\draw [shift={(60.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw (601,90) node   [align=left] {Time};
% Text Node
\draw (449,131.5) node   [align=left] {$\displaystyle n-1$};
% Text Node
\draw (374,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (182,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (301,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (450,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (61,54) node   [align=left] {$\displaystyle 1$};
...
**Solution:** Using the previous results, it follows that
$$\begin{aligned}
...
**Solution:** The present values of the payments can be obtained by
...
1.  *the accumulation at 12 years of ฿500 payable yearly in advance for
    the next 12 years.*

2.  *the present value now of ฿2,000 payable yearly in advance for the
    next 6 years.*

3.  *the present value now of ฿1,000 payable half-yearly in advance for
    the next 12.5 years.*
:::

**Solution:**

1.  The accumulation of the annuity-due of 12 years is
    $$500 \cdot \ddot{s}_\angl{12} = 500 \cdot \frac{1.08^{12} -1}{0.08/1.08} = 10247.648289.$$

2.  The present value of the annuity-due of 6 years is
...
(either in arrears or in advance) is called *immediate annuity*.
Otherwise, the annuity is known as *deferred* annuity, i.e. the first
...
```{tikz, tikz-ex17, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw    (60,106) -- (60,117) ;
%Straight Lines [id:da9474951160801843] 
\draw    (121,106) -- (121,117) ;
%Straight Lines [id:da6185331554915787] 
\draw    (303,105) -- (303,116) ;
%Straight Lines [id:da5682405407635602] 
\draw    (570,106) -- (570,117) ;
%Straight Lines [id:da43730719784498717] 
\draw    (420,105) -- (420,116) ;
...
\draw    (571,69) -- (570.53,98) ;
\draw [shift={(570.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da903069076316972] 
\draw    (360,105) -- (360,116) ;
%Straight Lines [id:da8911276783833124] 
\draw    (360,69) -- (359.53,98) ;
\draw [shift={(359.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5818501597930779] 
\draw    (240,105) -- (240,116) ;

% Text Node
\draw (61,131.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (120,132.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (304,131.5) node   [align=left] {$\displaystyle m$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle m+n$};
% Text Node
\draw (601,90) node   [align=left] {Time};
% Text Node
\draw (420,131.5) node   [align=left] {$\displaystyle m+2$};
% Text Node
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (421,54) node   [align=left] {$\displaystyle 1$};
...
\draw (571,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (361,131.5) node   [align=left] {$\displaystyle m+1$};
% Text Node
\draw (360,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (241,131.5) node   [align=left] {$\displaystyle m-1$};
% Text Node
\draw (175,126.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (495,49.5) node   [align=left] {$\displaystyle .\ .\ .$};
...
::: {.example}
*Calculate the present value at time 0 of an annuity of 1 p.a. in
arrears for 6 years and deferred for 10 at 6% effective rate p.a.*
:::

```{tikz, tikz-ex18, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw [shift={(570.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da903069076316972] 
\draw    (321,105) -- (321,116) ;
%Straight Lines [id:da8911276783833124] 
\draw    (321,69) -- (320.53,98) ;
\draw [shift={(320.5,100)}, rotate = 270.92] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da5818501597930779] 
\draw    (159,105) -- (159,116) ;

% Text Node
\draw (61,131.5) node   [align=left] {$\displaystyle 0$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle 16$};
% Text Node
\draw (601,90) node   [align=left] {Time};
% Text Node
\draw (420,131.5) node   [align=left] {$\displaystyle 12$};
% Text Node
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (421,54) node   [align=left] {$\displaystyle 1$};
...
\draw (571,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (322,131.5) node   [align=left] {$\displaystyle 11$};
% Text Node
\draw (321,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (160,131.5) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (223,126.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (495,49.5) node   [align=left] {$\displaystyle .\ .\ .$};
...
::: {.example}
*Give the reason or show that the present value of a series of* $(n+m)$
payments of one unit payable at the end of each time period is equal to
the sum of

1.  *present value of* $m$ payments of one units payable at the end of
    each time period (denoted by $a_\angl{m}$) and

2.  *present value of* $n$ payments of one units payable at the end of
    each time period deferred for $m$ years (denoted by
    $_{m \textbar}a_\angl{n}$).
:::

**Solution:** The present value of a series of (m+n) payments is
$$\begin{aligned}
...
$t_i = i$ is called an *(simple) increasing* annuity. The present and
...
::: {.example}
*Derive the formula for the present value of a simple increasing annuity
payable yearly in arrears with the effective rate* $i\%$ p.a. for $n$
years.
:::

**Solution:** The cashflows of the simple increasing annuity payable
...
```{tikz, tikz-ex19, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw (182,54) node   [align=left] {$\displaystyle 1$};
% Text Node
\draw (301,54) node   [align=left] {$\displaystyle 2$};
% Text Node
\draw (421,54) node   [align=left] {$\displaystyle 3$};
% Text Node
\draw (571,54) node   [align=left] {$\displaystyle n$};
...
1.  An increasing annuity but with payments in advance is given by
    $$(I\ddot{a})^{i}_\angl{n}   = \frac{\ddot{a}^{i}_{\actuarialangle{n}} - nv^n}{d}.$$

2.  The formulas for the accumulated values are
...
::: {.example}
*Assume that the effective rate of interest is 6% p.a. Calculate the
...
```{tikz, tikz-ex20, fig.ext = 'png', cache=TRUE, echo = FALSE, fig.align = 'center'}
...
\draw (302,131.5) node   [align=left] {$\displaystyle 2$};
% Text Node
\draw (571,129.5) node   [align=left] {$\displaystyle 8$};
% Text Node
\draw (601,90) node   [align=left] {Year};
% Text Node
\draw (420,131.5) node   [align=left] {$\displaystyle 3$};
...
\draw (495,125.5) node   [align=left] {$\displaystyle .\ .\ .$};
% Text Node
\draw (182,54) node   [align=left] {$\displaystyle 10$};
% Text Node
\draw (301,54) node   [align=left] {$\displaystyle 10( 1.02)$};
% Text Node
\draw (421,54) node   [align=left] {$\displaystyle 10( 1.02)^{2}$};
% Text Node
\draw (571,54) node   [align=left] {$\displaystyle 10( 1.02)^7$};
...
::: {.example}
*Calculate the accumulation at 1 January 2020 of an annuity of ฿100 per
month, payable in arrears from 1 January 2010 at an effective rate of
interest of 4% p.a.*
:::

**Solution:** The annual payment is 1200 and the effective rate per
...
-   **Effective rate of interest** is the interest $i$ paid at the end
    of the year on an amount ฿1 at the start of the year.

-   **Nominal interest rate payable** $p$ times per period, denoted by
...
as **the rate of interest convertible** $p$thly or compounded $p$thly.

::: {.example}
*A nominal rate of interest of* $i^{(4)} = 10\%$ p.a. convertible
...
**Solution:** When working with the nominal interest rate, the nominal
...
**Nominal** is used where interest is paid more frequently than once per
unit year.
...
**Note** In practice, it is easier to work with the effective rate of
interest which is defined in a suitable time unit.
...
**The nominal rate of discount payable** $p$ times per period $d^{(m)}$
...
::: {.example}
1.  *Express a nominal annual discount rate of 6% convertible
    half-yearly as an annual effective discount.*

2.  *Express an effective discount of 10% per half year as a nominal
    annual discount rate convertible quarterly.*
:::

**Solution:**

1.  The annual effective discount $d$ is
    $$d = 1-  \left(1 - \frac{d^{(m)}}{m}\right)^m = 1-  \left(1 - \frac{6\%}{2}\right)^2 = 0.0591 = 5.91\% \text{ per annum}.$$

2.  We know that the discount factor $v$ and the rate of discount $d$
...
two sequences of cashflows are said to be **equivalent** (or equal in
value) if their values at any time $t$ are the same, i.e. there exists
$t \in \mathbb{R}$ such that $$PV^C(t)  = PV^D(t).$$

**Notes**

1.  If two sequences of cashflows have the same value at time $s$, then
...
2.  The two sequences of cashflows are **indifferent** if their present
    values are the same.

3.  The principle of equivalent can be applied for **pricing a financial
    security**, for example, a price $P$ which will be paid by the
    investor in return for a series of future cashflows.

::: {.example}
*Calculate the maximum price an investor wish to pay in return for an
...
::: {.example}
*Determine whether the following series of cashflows are equivalent
given that an interest rate is 6% per annum effective.*

1.  *One single payment of amount 6,691.127888 at year 5.*

2.  *a level annuity of 300 payable yearly in arrears for the next 5
    years plus a lump sum of 5,000.*

3.  *a level annuity of 1,186.982002 payable yearly in arrears for the
    next 5 years.*
:::

**Solution:**

1.  The present value is $6,691.127888 \times (1.06)^{-5} = 5000$.

2.  The present value is
    $$300 a^{0.06}_{\angl{5}}   + 5000 \times (1.06)^{-5}  = 5000.$$

3.  The present value is $$1186.982002 a^{0.06}_{\angl{5}}     = 5000.$$
...
-   The **premium** for an insurance policy is calculated by equating
...
interest is called the **yield of the cashflows** (or **internal rate of
return, money-weighted rate of return**).

**Notes**

1.  Equations of values may have no roots, a unique root or multiple
    roots.

2.  In most practice situations, there is a unique positive real root.

::: {.example}
*An investor pays ฿1,000 in order to receive ฿600 back in 2 years and
...
**Solution:** The yield of the investment $i\%$ satisfies the equation
...
*An investor pays ฿1,000 in order to receive ฿300 back at the end of the
...
**Solution:** The yield of the investment $i\%$ p.a. satisfies the
equation of value
...
::: {.example}
*Approximate the yield of the transaction in Example*
\@ref(exm:exampleYield)*.*
:::

**Solution:** Here, When $i_1 = 0.21$, $P_1 = PV_{0.21}(0) = 19.448$ and
...
**term** of the loan is $n$ years with the loan **amount** of $L$. How
could we repay the loan?

### Repay as late as possible: {#repay-as-late-as-possible .unnumbered}
...
### Repay interest only during the term and repay the capital at the end of the term: {#repay-interest-only-during-the-term-and-repay-the-capital-at-the-end-of-the-term .unnumbered}

These types of loan where the borrower is a government or a company are
**bonds** or **fixed interest securities**.

### Repay loan by regular instalments of interest and capital throughout term of loan: {#repay-loan-by-regular-instalments-of-interest-and-capital-throughout-term-of-loan .unnumbered}

Each repayment must pay first for interest due and the remainder is used
to repay some of the capital outstanding.

::: {.example}
*You borrow ฿5,000 for a term of 3 years at a fixed interest rate of 10%
...
**Note** The loan payments can be expressed in the form of a **Loan
Schedule** as follows:
...
-   $i$ be the effective rate of interest per time unit charged on the
    ...
    | $\vdots$ |            |                  |                        |                                    |
    | t \$     | X_t\$ \$   | iL\_{t-1}\$ \$(X | *t - iL*{t-1})\$ \$L\_ | t = L\_{t-1} - (X_t - iL\_{t-1})\$ |
    | $\vdots$ |            |                  |                        |                                    |
    | n\$ \$   | X_n\$ \$   | iL\_{n-1}\$ \$(X | *n - iL*{n-1})\$       |                 0                  |

**Note** The capital outstanding after the $k$th payment is
...
::: {.example}
*A loan of ฿20,000 is repayable by equal monthly payments for 4 years,
with interest rate payable at 10% pa effective.*

1.  *Calculate the amount of each monthly payment.*

2.  *Calculate the interest and capital contents of the 25th repayment.*
:::

**Solution:**

1.  The loan is repaid by level instalments of amount $X$ payable
...
2.  The capital outstanding after 24th repayment =
...
::: {.example}
*A person takes out a loan of ฿100,000 to be repaid by level monthly
instalments in arrears over 7 years where the bank charges an effective
annual rate of interest of 6%*

1.  *Calculate the monthly repayment **Solution:** Working in months, we
...
2.  *Calculate the new repayment amount if the the term of loan can be
    extended by 1 year, immediately after the 60th repayment has been
    made. **Solution:** The capital outstanding after 60th repayment =*
...
3.  *Instead of extending the term, the person had requested to miss the
    61st and 62nd repayments. Calculate the remaining installments.
    **Solution:** After missing the 61st and 62nd repayments, the
    capital outstanding at time 62 =*
    $L_{60}\cdot (1+j)^2 = 32842.48 (1.004868)^2 = 33162.99.$ Hence, the
    remaining number of payments is 22.

4.  *Calculate the new repayment amount if the person repaid ฿10,000 at
    the time he made the 60th repayment together with the 60th
    repayment. **Solution:** The revised capital outstanding after
...
1.  interest rates have been planned to changed during the term, for
    example the borrower would repay less during the beginning of the
    loan, or

2.  the lender changes the rates of interest to reflect the market
    conditions.

::: {.example}
*You borrow ฿20,000 for a term of 20 years to be repaid by level annual
...
**Solution:** Let $X$ be the annual repayment. Using an equation of
value, we have
$$20000 = X a^{7\%}_{\angl{10}} + (1.07)^{-10} X a^{8\%}_{\angl{10}}.$$
Then solving for $X$ gives $X = 1916.69$.

::: {.example}
*You borrow ฿20,000 for a term of 15 years to be repaid by level annual
...
**Solution:** The annual repayment $X$ **for a term of 15 years** before
...
issuing *fixed interest securities (FIS)*, also called *bonds*. Bonds
...
payments known as *coupons* at fixed dates plus repayment of the loan at
the end of the term.

**Note** The loan is usually split into smaller units that can be traded
...
### Characteristics of Bonds {#characteristics-of-bonds}

1.  The *nominal amount or face value* of a bond is the amount of the
    loan it represents. The nominal amount is usually ฿1,000 (without
    further specific, we will set the nominal amount to be ฿100.)

2.  The interest payments are called *coupons*, usually expressed as a
    percentage per year of the nominal amount. The rate of interest
    denoted by $D$ is also known as *coupon rate*. They are always **in
    arrears**.

3.  Coupons are usually expressed as the amount of interest payable in a
    year, but are paid half-yearly (twice per year) or quarterly (4
    times per year)

4.  *Coupon dates* are the dates on which the bond issuer will make
    interest payments.

5.  Bonds have *maturity dates* at which point the principal amount must
    be paid back in full.

6.  The loan is repaid or redeemed at the end of the term. The
    redemption amount per 100 nominal is the *redemption rate*, often
...
7.  Many corporate and government bonds are publicly traded; others are
    traded only over-the-counter (OTC) or privately between the borrower
    and lender.

::: {.example}
*Each bond of ฿100 nominal value carries coupons of 6% pa payable
half-yearly.*
:::

**Solution:** The coupon rate of 6% pa payable half-yearly means that
bondholders will receive
$$ \frac{6\%}{2} \times 100 = ฿ 3 \text{ every half-year}.$$

::: {.example}
*An investor purchases ฿95 for a 5-year fixed interest bond with face
...
::: {#exampleBondPrice .example}
*A company issues a 10-year bond, to be redeemed at 102%, with coupon of
...
::: {#exampleBondPrice2 .example}
*A tax-exempt investor buy the bond in Example*
\@ref(exm:exampleBondPrice) *on its issue date. Calculate the price the
...
::: {.example}
*Refer to Examples* \@ref(exm:exampleBondPrice) *and*
...
1.  *Calculate the price that he will obtain.*

2.  *Calculate the yield that the first investor obtains if he paid
...
1.  The remaining payments are shown in the table below.
...
2.  The payments of the investor are shown in the table below.
...
1.  If the investor is not subject to taxation, the yield is called the
    *gross yield*.

2.  The yield obtained by holding the bond until redemption is called
    *redemption yield*. This is quoted in financial newspapers.

3.  If a bond is sold before redemption, the yield that the investor
    obtains is called *realised yield*. This yield depends on both the
    buying and selling prices.

**Notes**

1.  There is an inverse relationship between the bond prices and yields.

2.  The nominal amount of the loan is just a theoretical figure on which
    the coupon and redemption rates are based.

3.  The amount of capital the borrower can actually raise on the issue
    date is the price that investors are willing to pay for the future
    income stream and also set by supply and demand.

4.  The investors also consider the **credit risk** of the borrower. It
    is the risk that they might default on interest and capital
    payments.

5.  The greater the credit risk, the higher the yield they will require.

6.  The bonds can be traded on an exchange at any time until it is
...
the rate is called the *net yield*.

::: {.example}
*An investor liable to income tax at 30% buys a 15-year fixed interest
...
**Solution:** Coupon payments after tax are
...
Note that **capital gain** refers to an increase in a capital asset's
value and is considered to be realized when the asset is sold. A
**capital loss** is incurred when there is a decrease in the capital
asset value compared to an asset's purchase price.

::: {.example}
*An investor liable to the capital gains tax at 20% purchases two bonds*

-   *Bond A for the price of ฿102 and*

-   *Bond B for the price of ฿98.*

*Calculate the capital gains tax on each bond if the investor sells them
...
1.  Similar to income tax, the price of the bond is then calculated on
    the net redemption received after tax has been deducted.

2.  When the purchase and sale (or redemption) prices are known, it it
    easy to calculate the yield.

3.  In contrast, as the price depends on whether there is a capital gain
...
::: {.example}
*An investor liable to the capital gains tax at 20% purchases a 10-year
bond with an annual coupon of 8% pa payable yearly in arrear, to be
redeemed at par.*

1.  *Calculate the redemption yield the investor obtain if the price is
    ฿96 per ฿100 nominal.*

2.  *What price should the investor pay to obtain a yield of 7% pa
    effective?* (see note below)

3.  *What price should the investor pay to obtain a yield of 9% pa
    effective?*\
:::

**Solution:**

1.  The bond is redeemed at par. Therefore, the redemption amount is 100
...
2.  We know that $P = 96$ is equivalent to yield approximately equal to
    $8.546\%$.
...
-   **CGT is payable:** The equation of value is
    $$ P = 8 a^i_{\angl{10}} +  99.2\cdot (1+i)^{-10}, \quad i = 7\%$$

-   **CGT is not payable:** The equation of value is
    $$ P = 8 a^i_{\angl{10}} +  100\cdot (1+i)^{-10}, \quad i = 7\%$$

**Note** In this example, we can guess whether CGT is payable because we
...
According to the note, let us guess that $P > 100$, i.e. CGT is **not**
payable.
...
3.  Here $9\% > 8.546\%$. Let us guess that $P < 100$, i.e. CGT is
    payable.
    $$ P = 8 a^i_{\angl{10}} +  99.2\cdot (1+i)^{-10}, \quad i = 7\%,$$
    which implies that $P = 92.99 < 100$. So our initial guess was
    correct and CGT is payable.

**Note** The algorithm to test whether CGT will be payable will be
...
-   In Thailand or US, it is measured with reference to a **consumer
    price index** (or CPI). In UK, it is measured in terms of **retail
    price index** (RPI).

-   Bureau of Trade and Economic Indices reports the CPI on a monthly
    basis.

-   High inflation means that prices increase quickly and hence **the
...
::: {.example}
*A set of goods costs ฿98.25 in January 2013 and ฿101.44 in January
2018. Calculate the average inflation rate* $\bar{q}$ over this period.
:::

**Solution:** The increase from Jan 2013 to Jan 2018 (5 years) is
...
January 2011 to December 2019. Source: <http://www.price.moc.go.th/>
...
: (\#tab:tableCPI) The monthly consumer price indices from January 2011
to December 2019.
...
```{r, figCPI, echo = FALSE, fig.cap="The monthly consumer price indices from January 2011 to December 2019", fig.align = 'center'}
# https://stats.idre.ucla.edu/r/faq/how-can-i-format-a-string-containing-a-date-into-r-date-object/

#CPIData <- read_excel("~/Documents/LectureNotes2019/SCMA329/2021LectureNotes/CPIData.xlsx")
CPIData <- read_excel("CPIData.xlsx")

dat <- CPIData


dat <- dat %>% mutate(JAN = as.numeric(JAN)) %>% pivot_longer(cols = JAN:DEC, names_to = "month", values_to = "CPI") %>% mutate(Date = paste0("01/",month,"/",Year) %>% as.Date(format = "%d/%b/%Y")) %>% select(Date, CPI) 

ggplot(dat,aes(x = Date, y = CPI)) + geom_point()
```

::: {.example}
*An investment contract made on January 2018 promises to pay an investor
of ฿10,000 in 5 years' time. Assume the average inflation rate at*
$\bar{q} = 0.64\%$ for the next 5 years.

*If a bowl of noodles costs ฿100 in 2018, then ฿10,000 could buy 100
bowls. How many bowls of noodles would the payment of ฿10,000 buy in the
next 5 years?*

***Solution:** In Jan 2018, ฿100 buys as much as* $100 (1.0064)^5 =$
฿103.2 in Jan 2023.

*So ฿10000 in Jan 2023 could buy*
...
-   *The quantity of goods that can be bought with 10,000 in January
    2023 reduces from 100 to 96 bowls.*

-   *The effect of inflation results in the reduction of the purchasing
    power of a unit of money in January 2023 compared to that in
    January 2018.*

-   *The amount of ฿10,000 is referred to as the **monetary** (or
    **nominal**) payment in 5 years. This is the amount of money that
    change hands.*

-   *The **real payment of ฿10,000 (due at time 5 years) in time 0
...
-   *The real payment (in time 0) is the purchase power of 10,000 paid
    in 5 years relative to today. **It is the amount of cash in hand at
    the end of the period reduced for the effects of inflation**.*

-   *In general, ฿X at time* $t$ has the purchasing power relative to
...
called a **money (or monetary or nominal) rate of interest**.

The **real rate of interest** is calculated using real payments.

::: {.example}
*An investor deposits 100 at time 0 and receives 120 after one year.*

-   *The monetary rate of interest effective is*
    $$\frac{120}{100} - 1 = 20\%.$$

-   *Suppose that the inflation rate over this one year period is 4%.
    ...
    -   *In term of time 0 money unit, the transaction is represented
        by*

        *Here, the real payment of 120 due in 1 year in terms of time 0
        unit is* $\displaystyle{120 \cdot \frac{1}{1.04} = 115.38}$.
        Hence the real rate of interest is 15.38%.

    -   *In term of time 1 money unit, the transaction is represented
        by*

        *Similarly, we instead calculate the real payment of 100
...
interest, a **real yield** is calculated using real payments, which can
be obtained by expressing payments in units of the same purchasing power
**at some specific date**.

::: {.example}
*A 5-year bond with nominal value of ฿100 was issued in January 2013.
...
1.  *in monetary terms **Solution:***

    *The transaction together with the inflation indices* $Q(t)$ at time
    $t$ is shown as follows:

    *Clearly, the monetary rate of return on this transaction is 8%.
    ...
    *Alternatively, one can solve for the monetary rate of return from
    the following equation of value*
    $$f(i) = -100 + 8 a^i_{\actuarialangle{5}} + 100\frac{1}{(1+i)^5} = 0.$$

2.  *in real terms with reference to the CPI.*

    *Taking into account of the inflation rates, we calculate the real
    payment in term of time 0 unit by dividing the monetary amounts by
    the **proportional** increase in the inflation index from 0 to* $t$.
...
+-------------+---------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+
| Real        | -100    | $8 \cdot \frac{98.25}{100.15}$   | $8 \cdot \frac{98.25}{99.74}$    | $8 \cdot \frac{98.25}{99.21}$    | $8 \cdot \frac{98.25}{100.75}$   | $8 \cdot \frac{98.25}{101.44}$ |
| value       |         | = 7.85                           | = 7.88                           | = 7.91                           | = 7.80                           | = 104.60                         |
| of cashflow |         |                                  |                                  |                                  |                                  |                                  |
| at          |         |                                  |                                  |                                  |                                  |                                  |
| $t = 0$     |         |                                  |                                  |                                  |                                  |                                  |
+-------------+---------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+
...
Therefore, **the real yield is independent of the date the payment units
are adjusted to**.
...
**we assume a constant rate of inflation** $q$ p.a., then the following
...
::: {.example}
*Consider an index-link bond of a nominal of ฿100 issued at time* $t_0$,
...
::: {#exampleILB .example}
*An investor purchased a 3-year index-linked bond in January 2015. The
...
values reported in Table* \@ref(tab:tableCPI)*. Calculate the actual
payments received by the investor.*
:::

**Note** In practice, due to delays in calculating the index, the
...
::: {.example}
*Repeat Example*\@ref(exm:exampleILB) *for a 3-year index linked bond.
The indexation adjustments are made according to the CPI three months
before each payment, i.e.* $s = 3$ months.
:::

::: {#exampleILB2 .example}
*In January 2015, the government issued an index-linked bond of term 10
...
1.  *Find the base CPI figure (i.e. it is the October 2014 CPI which is
    3 months before the issue date).*

2.  *Calculate the actual payments received by the investor.*

3.  *Assume that the price of ฿100 nominal of this index-linked bond in
...
4.  *Calculate the real yield for this investor under the above
    assumptions.*
:::
...
**geometric Brownian motion**. This is one of the main tools in
...
We will first begin with the brief introduction of the **force of
interest** (or **continuous compounding**). The process for a stock
...
the **equivalent nominal rates**, $i^{(n)}$, of interest convertible $n$
...
::: {.example}
*Given the annual effective rate* $i = 4\%$,

1.  *calculate the equivalent nominal rates of interest convertible* $n$
    times a year for $n = 2,4,12, 52,$ and 365,

2.  *find the limit of* $i^{(n)}$ as $n$ tends to infinity, and

3.  *plot the graph of* $i^{(n)}$ as a function of $n$.
:::

**Notes**

1.  Using the result from calculus, we can show that
    $$\lim_{n \rightarrow \infty} \left(1 + \frac{x}{n} \right)^n = \exp(x).$$

2.  As $n$ tends to infinity, a rate of $i^{(n)}$ compounding $n$ times
    a year converges to a constant, which will be denoted by $\delta$,
    i.e. $i^{(n)} \rightarrow \delta$ as $n \rightarrow \infty$.

3.  The above observations imply following relation:
    $$\lim_{n \rightarrow \infty} \left(1 + \frac{i^{(n)}}{n} \right)^n  = \exp(i^{(\infty)}) = \exp(\delta),$$
    where we write $i^{(\infty)} = \delta$.

4.  The constant $\delta$ is known as the **force of interest** or also
    known as a **continuous compounded rate**. It is the interest rate
    paid continuously throughout the period. It is a constant **force**
    that causes the initial investment to grow.

5.  The following relationship between the force of interest and the
    annual effective rate of interest holds:
    $$1 + i = \exp(\delta) \quad \text { or } \delta = \ln(1+i).$$

::: {.example}
*฿200 is invested in an account which pays a force of interest of 4% pa.
Calculate the amount in the account after 3 years.*
:::

::: {.example}
*A payment of ฿500 is due in 5 years' time. Calculate the present value
...
$$V(s,t) = \exp( -\delta (t-s)).$$ **Notes**

1.  In general, the force of interest $\delta(t)$ per annum at time $t$
    is a function of $t$.

2.  Given the force of interest per annum $\delta(t)$, the accumulation
...
3.  The more detailed discussion regarding the force of interest and
...
::: {.example}
*A payment of ฿1000 is due in 1 years' time. Calculate the accumulated
...
3.  Topics on stochastic processes will be discussed in the course "SCMA
...
simple model is called a **simple random walk**.
...
**Note** When $p = 1/2$, the value of the process increases or decreases
randomly by 1 unit with equal probability. In this case, the process is
known as a **symmetric** random walk.

::: {.example}
*Calculate the expectation and variance of the random variable* $Z_i$.
:::
...
::: {.example}
*Calculate the expectation and variance of the process* $X_n$ at time
$n$.
:::
...
::: {.example}
*We flip the coin once to represent each trading day. If the coin comes
...
has an infinite number of **stochastic realisations**. A **sample path**
...
```{r FigRW, fig.cap= 'Some stochastic realisations of the simple random walk', echo = FALSE}
...
**Solution:** The process $X_n$ must decrease on the first two days,
...
![Three possible sample paths](RWThreePaths.pdf){#fig:SamplePaths
width="3in"}
...
1.  Generate $N$ random samples from the discrete distribution of the
    random variable $Z_i$, $i = 1,\ldots, N$, as follows:

    1.  We first generate random numbers from the uniform distribution
        $U(0,1)$. Denote these numbers by $U_i$.

    2.  If $U_i \le p$, then set $Z_i = 1$. Otherwise, $Z_i = -1$

2.  The value $X_n$ of the random walk process at time $n$,
    $1 \le n \le N$, can then be calculated from
    $$X_n = a + \sum_{i=1}^n  Z_i.$$

**Notes**

1.  Excel provides two function **RAND()** and **RANDBETWEEN(a,b)** to
    generate a random number between 0 and 1 and a random integer
    between $a$ and $b$.

2.  Excel also provides Random Number Generation to draw sample numbers
    from some specified distributions (to be discussed in Excel Lab).

![Simulating a sample path of a simple random walk](RW.pdf){#fig:RW
width="8in"}
...
::: {.example}
*Using Monte Carlo estimation, approximate the expectation*
...
**Solution:** We generate samples $X_1,X_2,...,X_N$ from the model $X$
...
A **Markov process** is any stochastic process that satisfies the Markov
property

**Notes**

1.  Stock prices are usually assumed to follow a Markov process where
    only the current stock price is relevant for predicting future
    prices, and thus the past values are irrelevant

2.  Predictions in the future is uncertain, and must be expressed in
...
3.  **Time series models** are widely used in economics, business and
...
increment process $Z_i$. The **Wiener process** is a Markov process
which will be used to **model the change in the stock prices**.

The Wiener process is a (**continuous-time stochastic**) process which
can be described by a variable $W$ having the following properties:

-   We assume that the current value is 0 (i.e. $W(0) = 0$) and **the
    ...
    **Notes** The following properties of the normal distributions are
    useful.

    1.  Given $X \sim N(\mu, \sigma^2), Y = a + bX$, it follows that
        $$Y \sim N(a + b\cdot \mu, b^2 \sigma^2).$$

    2.  Given $X \sim N(\mu_X, \sigma_X^2), Y \sim N(\mu_Y, \sigma_Y^2)$
        with $X, Y$ independent, it follows that
        $$X + Y  \sim N(\mu_X + \mu_Y, \sigma_X^2 + \sigma_Y^2).$$

    3.  It is well known that if two i.i.d. random variables are
...
-   The probability distribution of the change in the value of the
    ...
    -   The change in 2 years is the sum of two normal distributions,
        each of which has mean of 0 and variance of 1. **Solution:**
        $$\begin{aligned}
        ...
        **independent**. Hence the sum of two independent normal
    ...
    -   For the change in 6 months, the variance of the change in the
        ...
        the six-months period are the same (or **identical**). As a
...
::: {.example}
*Given that* $W(0) = a$, what is the probability distribution of the
...
More precisely, a **standard Brownian motion** or **standard Wiener
...
2.  For $0 \le s < t \le T$, the **change (or increment)** $W(t) - W(s)$
    is normally distributed with mean zero and variance $t -s$.

3.  For $0 \le s < t < u < v \le T$, the change (or increment)
    $W(t) - W(s)$ and $W(v) - W(u)$ are independent.

**Notes**

1.  The second condition above implies that the change
    $W(t) - W(s) \sim \sqrt{t-s} N(0,1)$, where $N(0,1)$ denotes a
    normally distributed random variable with mean zero and unit
    variance.

2.  The uncertainty about the value of the standard Brownian motion
...
1.  We set $\Delta t = T/N$ for some positive inter $N$ and let $W_j$
    denote $W(t_j)$ with $t_j = j \cdot \Delta t$

2.  Condition 1 implies that $W_0 = 0$ with probability 1, and
...
1.  How can I simulate values of a normal random variable?
...
2.  In ordinary calculus, the notation $$dx = a dt$$ indicates that
    $\Delta x = a \Delta t$ in the limit as $\Delta t \rightarrow 0$.
    This means that the change in $x$ per unit of time is constant, i.e.
    equal to $a$.

3.  In stochastic calculus, we use $dW$ as a Wiener increment which is
    the limit of $\Delta W_j$ as $\Delta t \rightarrow 0$.

4.  We see that the Wiener process has very jagged (irregular) sample
    paths.

![Simulating a sample path of the standard Brownian
motion](BM.pdf){#fig:BM width="8in"}

In the following example, we do not assume that $W_0 = 0$ with
probability 1.

::: {.example}
*Consider a Wiener process denoted by* $W(t)$ with $W(0) = a$ with
probability 1. The time is measured in years.

1.  *What is the probability distribution of the value of the variable
    at the end of one year, i.e.* $W(1)$?

2.  *What is the probability distribution of the value of the variable,
    i.e.* $W(4)$? and what is the mean and the standard deviation of
    $W(4)$.

*What is the probability distribution of the change in the value of W
...
parameters. This new process is known as a **generalised Wiener
process** or **Brownian motion with drift**.
...
**Note** The process defined above is also known as a **linear
stochastic differential equation**.

-   The term $a dt$ (deterministic term) implies that $X$ has an
    **expected drift rate** of $a$ per unit of time (or the mean change
...
-   The stochastic or random component $b dW$, measured in terms of the
    variance of the change in $X$, adds **uncertainty**, **noise** or
    **variability** to the path followed by $X$. The term $b^2$ is
    referred to as the **variance rate**.
...
::: {.example}
*Calculate the probability that the generalised Wiener process* $X(t)$
...
**Solution:** The change of process over 4 units of time is given by
...
1.  The standard Wiener process has the expected drift rate of zero,
    $a = 0$ and unit variance rate (noise or variability) $b^2 = 1$. For
    the generalised Wiener process, the amount of this noise or
    variability is $b$ times a Wiener process. For **each time unit**,
...
2.  The change in the value of the process $X$ in any time interval $t$
...
3.  In general, the drift and variance rates of a stochastic process may
...
::: {.example}
*Consider the cash position of a company measured in millions of Thai
...
1.  *What is the distribution of the process at the end of the first
    year,* $X(1)$?

2.  *What is the distribution of the process at the end of 6 months,*
    $X(1/2)$?

3.  *What is the probability that the cash position will be at least 60
    million baht at the end of 6 months?*
:::

**Solution:**

1.  At the end of the first year, we know that
    $$X(1) - X(0) \sim N(a \cdot 1, b^2 \cdot 1),$$ where $a = 10$ and
    $b^2 = 400$. It follows that
    $$X(1) \sim N(X(0) + a , b^2 ) = N(60, 400).$$

2.  Similarly, at the end of 6 months,
    $$X(1/2) - X(0) \sim N(a \cdot \frac{1}{2}, b^2 \cdot \frac{1}{2}),$$
    or $$X(1/2) \sim N(55,200).$$

3.  The required probability is $$\begin{aligned}
...
1.  We first discretise the interval by let $\Delta t = T/N$ for some
    positive integer $N$ and $t_j = j \cdot \Delta t$.

2.  Denote $X(t_j)$ by $X_j$. The value $X_j$ can be approximated by
...
![Simulating a sample path of the generalised Wiener process with
$a =0.5$ and $b = 2$.](GW2.pdf){#fig:GW width="8in"}
...
of a non-dividend-paying stock. The model is known as **geometric
Brownian motion**. We will show that this stochastic model assumes or
implies the following properties for stock prices.

1.  The process is **continuous in time and value**.

2.  It possesses the **Markov property**, i.e. future prices depend only
    on its the current stock price and not on its the past historical
    values.

3.  The **proportional return on a stock** over a short time interval is
    normally distributed.

4.  The **price of a stock** is lognormally distributed.

5.  The **continuously compounded rate of return per year** for a stock
    is normally distributed.

::: {.example}
*Explain why a generalised Wiener (GW) process is inappropriate to model
a stock price.*
:::

**Solution:** The GW model assumes that the expected change (not the
...
### Model Assumptions of the Geometric Brownian Motion {#model-assumptions-of-the-geometric-brownian-motion}

The geometric Brownian motion also consists of two components:

1.  **The deterministic component:** The model assumes that the expected
    ...
    **Note** When there is no uncertainty, the stock price grows at a
...
2.  **The stochastic component:**
    ...
    deterministic component, the **geometric Brownian motion** can be
    expressed as $$dS = \mu S dt + \sigma S dW$$ where $W$ is a standard
    Brownian motion (or a Weiner process).

**Notes**

1.  The geometric Brownian motion is the continuous-time version of a
    random walk.

2.  The discrete-time version of the geometric Brownian motion is
    $$\frac{\Delta S}{S} = \mu \Delta t + \sigma \sqrt{\Delta t} \epsilon,$$
    where $\epsilon$ has a standard normal distribution (with zero mean
    and unit variance ) The parameter $\mu$ is the **expected rate of
    return per unit of time** from the stock, and $\sigma$ is the
    **volatility** of the stock price.

#### Proportional return on stocks are normally distributed {#proportional-return-on-stocks-are-normally-distributed}
...
::: {.example}
*Consider a stock that pays no dividends, provide an expected return of
...
1.  *Calculate the change of the stock price over 1 day, assuming that
    there are 250 trading days per year.*

2.  *Calculate the stock price over 10 days if the random samples for*
    $\epsilon$ are given in Figure [3.6](#fig:GBM){reference-type="ref"
    reference="fig:GBM"}.
:::

**Solution:**

1.  Given that $\mu = 0.2$ and $\sigma = 0.4$ per annum, the process of
...
2.  Leave as an exercise.

![Simulating a sample path of a geometric Brownian motion with
$\mu =0.2$ and $\sigma = 0.4$.](GBM.pdf){#fig:GBM width="8in"}

**Notes**

1.  The parameter $\mu$ is the annualised expected return in a short
...
2.  The value of a (financial) derivative, for example options, is
    independent of $\mu$. So we do not need to concern with the
    estimation of $\mu$.

3.  The parameter $\sigma$, the stock price volatility, is important to
    determine the value of (financial) derivatives. We will discuss how
    to estimate $\sigma$.

4.  The standard deviation of the proportional change in the stock price
    in a **small interval** $\Delta t$ is $\sigma \sqrt{\Delta t}$. For
    a **relatively long period** of time $T$, it is approximately equal
    to $\sigma \sqrt{T}$.

    As a result, **the volatility** $\sigma$ can be interpreted as the
    standard deviation of the change in the stock price in 1 year.

### Stock prices are lognormally distributed {#stock-prices-are-lognormally-distributed .unnumbered}
...
1.  The logarithm of a price follows a generalised Wiener process with
    drift rate $\mu - \sigma^2/2$ and variance rate $\sigma^2$.

2.  The mean of the distribution for the change in logarithm of price
    over each time unit (i.e. log return) is not $\mu$ but
    $\mu - \sigma^2/2$.

3.  Why do stock prices follow a lognormal random variable? Let $X_i$
...
4.  Recall that if the random variable $X$ is lognormally distributed,
...
2.  *Calculate the mean and the standard deviation of* $\ln S_T$ in 3
    months' time.

3.  *Find the 95% confidence interval of* $S_T$ in 3 months' time.
:::

**Solution:**

1.  Given that $\mu = 0.2$, $\sigma = 0.4$ per annum and $S_0 = 20$, the
...
2.  It follows that for $T$ = 0.25 years,
    $$\mathrm{E}[\ln S_T] = 3.026,   \text{ and    } \text{SD}(\ln S_T) = \sqrt{0.04} = 0.2.$$

3.  The 95% CI of $\ln S_T$ for $T$ = 0.25 years, is $$\begin{aligned}
...
**Note** It should be noted that $$\begin{aligned}
...
1.  A variable that has a lognormal distribution can take any value
    between zero and infinity. It is not symmetrical unlike the normal
    distribution.

2.  From the properties of the lognormal distribution, the expected
...
### More accurate simulation : the lognormal model {#more-accurate-simulation-the-lognormal-model}
...
**Note** The above equations follows from the fact that the process
...
probability distribution of the **continuously compounded rate of return
per year** for a stock is **normally distributed**.
...
1.  The standard deviation of $\delta$ declines as we consider longer
...
2.  When $T = 1$, the standard deviation of the stock return equal
    $\sigma$. As been seen earlier, the **volatility of a stock is the
...
-   Equation [$$propReturn$$](#propReturn){reference-type="eqref"
    reference="propReturn"} shows that the expected percentage change
    (or proportional change) in the stock price in a very short period
    of time, $\Delta t$ is $\mu \Delta t$.

    Hence, $\mu$ is the **expected rate of return per year for the stock
    for infinitesimal interval of time**.

-   Whereas, $\mu - \sigma^2/2$ is the **expected continuously
    ...
    [$$returnRate$$](#returnRate){reference-type="eqref"
    reference="returnRate"}).

**Notes**

1.  Recall that the expected price of a stock grows at the continuously
    compounded rate of $\mu$ and we can write
    $$\mathrm{E}[S_T] = S_0 \exp(\mu T).$$

2.  However, the expected continuously compounded rate of return per
...
3.  As a result, we cannot get the expected future price of the stock by
    growing its current price at the expected continuously compounded
    rate of return per year.

4.  If two stocks have the same price today and the same $\mu$, then
...
1.  Given the stock price $S_i$ at end of the $i$th interval for
    $i = 0,1, \ldots, n$, we define
    $$u_i = \ln \left(\frac{S_i}{S_{i-1}} \right), \quad \text{ for } i = 0,1, \ldots, n$$

2.  The estimates of the mean and standard deviation of the **daily
...
3.  Because we are using observations at intervals of $\tau$ measured in
    years, the estimate of the **annualised volatility** is given by
    $$\hat{\sigma} = \frac{s}{\sqrt{\tau}}.$$ The **standard error of
...
**Note** It follows from
[$$returnRate$$](#returnRate){reference-type="eqref"
reference="returnRate"} that the estimated expected return $\hat{\mu}$
is given by
$$\hat{\mu}  =  \frac{\bar{u}}{\tau}  + \frac{\hat{\sigma}^2}{2} = \frac{\bar{u}}{\tau}  + \frac{s^2}{2\tau} .$$

::: {.example}
*Verify the calculation using the stock price historical data from the
table below.*
:::

**Solution:** See an accompanied Excel file.

![Computation of volatility](VolatilityEstimation2.pdf){#fig:volatility
width="7in"}
